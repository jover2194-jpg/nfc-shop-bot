...
PRODUCT_INFO = {
    "google": {
        ...
        "description": (
            "⭐ *Google Card*\n\n"
            "One tap sends happy customers straight to your Google review page — "
            "no searching, no typing, no excuses to skip it.\n\n"
            "Perfect if you want more 5-star Google reviews to boost local search "
            "ranking and win trust from new customers before they even walk in.\n\n"
            "🔑 *Key Features*\n"
            "📲 Tap & Review — works on any NFC phone, no app needed\n"
            "🔗 QR code backup for older phones\n"
            "📈 More reviews = higher local search ranking\n"
            "🛠️ Free setup — just tap to link your Google Business Profile\n"
    ...
    "trustpilot": {
        ...
        "description": (
            "⭐ *Trustpilot Card*\n\n"
            "Turn a great in-person experience into a verified Trustpilot review "
            "in seconds — just tap and leave a rating.\n\n"
            "Ideal for businesses that rely on Trustpilot to build trust online, "
            "especially before a customer books or buys again.\n\n"
            "🔑 *Key Features*\n"
    ...
    "tripadvisor": {
        ...
        "description": (
            "⭐ *Tripadvisor Card*\n\n"
            "Built for restaurants, hotels, and attractions that live and die by "
            "their Tripadvisor ranking. One tap, one review, no friction.\n\n"
            "More reviews means a better ranking — and a better ranking means "
            "more bookings from travellers who haven't visited you yet.\n\n"
            "🔑 *Key Features*\n"
            "📲 Tap & Review — ideal for hospitality & travel\n"
            "🔗 QR code backup included\n"
    ...
    "whatsapp": {
        ...
        "description": (
            ...
            "Customers tap once to join your WhatsApp broadcast list or "
            "community — instantly, with zero typing.\n\n"
            "Great for building a direct line to your customers for offers, "
            "updates, and repeat business.\n\n"
            "🔑 *Key Features*\n"
            "📲 Tap to join — no saving numbers manually\n"
            "🔗 QR code backup included\n"
            "📣 Build a direct marketing channel you own\n"
    ...
    "telegram": {
        ...
        "description": (
            ...
            "Grows your Telegram channel or group with a single tap — no "
            "searching for your username, no friction.\n\n"
            "Ideal if you run a community, deals channel, or updates group and "
            "want it to grow every day without lifting a finger.\n\n"
            "🔑 *Key Features*\n"
            "📲 Tap to join — instant channel/group access\n"
            "🔗 QR code backup included\n"
            "📣 Grow your audience passively, every day\n"
    ...
    "social": {
        ...
        "description": (
            "📸 *Social Media Card*\n\n"
            "One card links customers to all your profiles — Instagram, TikTok "
            "and Facebook — in a single tap.\n\n"
            "Perfect for growing your following from foot traffic, especially if "
            "you post content customers will want to follow for more.\n\n"
            "🔑 *Key Features*\n"
            "📲 Tap once — links to all 3 platforms\n"
            "🔗 QR code backup included\n"
            "📣 Turn foot traffic into online followers\n"
